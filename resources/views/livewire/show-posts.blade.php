      ...
      <div class="xl:container bg-white rounded shadow p-6 mt-4">
          <div class="mb-4">
            <div class="flex-1 min-w-0">
              <div class="mt-1 flex flex-col sm:flex-row sm:flex-wrap sm:mt-0 sm:space-x-6">
                <div class="mt-2 flex items-center text-sm text-gray-500">
                  ...
                  @if($posts->isNotEmpty())
                    Último post dia {{ $posts[0]->created_at->format('d/m/Y') }}
                  @else 
                    Nenhum post
                  @endif
                </div>
            ...
            <div class="flex mt-4">
                ...
                <button class="flex-no-shrink p-2 border-2 rounded text-teal border-none bg-orange-400 text-white hover:bg-teal cursor-pointer focus:outline-none">Search</button>
            </div>
          </div>
          <div>
